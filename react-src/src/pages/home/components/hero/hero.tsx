...
const Hero = () => {
  ...
  return (
    ...
    >
      <Row className="h-100 d-flex flex-column-reverse flex-lg-row flex-nowrap">
        <Col className="d-flex justify-content-center align-items-center">
          <div className="text-white d-flex justify-content-center align-items-center  flex-column p-3">
